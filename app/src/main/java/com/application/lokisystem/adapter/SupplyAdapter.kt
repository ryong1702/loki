...
class SupplyAdapter: ListAdapter<Top5, SupplyAdapter.SupplyViewHolder>(SupplyCallback) {
        ...
        fun bind(item: Top5) {
            with(binding) {
                ...
                rcList.setOnClickListener{
                    ...
                    intent.putExtra("navigationName", root.resources.getString(R.string.model))
